...
int do_md5(md5_word_t word, md5_byte_t* hash) {
  ...
  */
  ...
  if (hash[0]   == (md5_byte_t)(a >> 0)   &&
      hash[1]   == (md5_byte_t)(a >> 8)   &&
      hash[2]   == (md5_byte_t)(a >> 16)  &&
      hash[3]   == (md5_byte_t)(a >> 24)  &&

      hash[4]   == (md5_byte_t)(b >> 0)   &&
      hash[5]   == (md5_byte_t)(b >> 8)   &&
      hash[6]   == (md5_byte_t)(b >> 16)  &&
      hash[7]   == (md5_byte_t)(b >> 24)  &&

      hash[8]   == (md5_byte_t)(c >> 0)   &&
      hash[9]   == (md5_byte_t)(c >> 8)   &&
      hash[10]  == (md5_byte_t)(c >> 16)  &&
      hash[11]  == (md5_byte_t)(c >> 24)  &&

      hash[12]  == (md5_byte_t)(d >> 0)   &&
      hash[13]  == (md5_byte_t)(d >> 8)   &&
      hash[14]  == (md5_byte_t)(d >> 16)  &&
      hash[15]  == (md5_byte_t)(d >> 24)
    ) return 1;
